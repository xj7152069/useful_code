/*
    Two - or three-dimensional Elastic wave simulation  
    by velocity - stress equations.
...
void elastic3D_ARMA::initialize(const int x, const int y, const int z)
{
    ...
    PML_wide=30.0;isPMLSurface=1.0;R=8.0;
...
void TimeSliceCal_elastic3D_PurePwave_MultiThread(class elastic3D_ARMA & obj)
{
    ...
    useThread[3]=thread(calx_3d,&obj.txx_pdx_t2,&obj.txx_pdx_t1,\
        &obj.vx,&obj.mpar_lmd_add_2miu,jc0,&obj);
    useThread[4]=thread(caly_3d,&obj.txx_pdy_t2,&obj.txx_pdy_t1,\
        &obj.vy,&obj.mpar_lmd,jc0,&obj);
    useThread[5]=thread(calz_3d,&obj.txx_pdz_t2,&obj.txx_pdz_t1,\
        &obj.vz,&obj.mpar_lmd,jc0,&obj);
    useThread[6]=thread(caly_3d,&obj.tyy_pdy_t2,&obj.tyy_pdy_t1,\
        &obj.vy,&obj.mpar_lmd_add_2miu,jc0,&obj);
    useThread[7]=thread(calx_3d,&obj.tyy_pdx_t2,&obj.tyy_pdx_t1,\
        &obj.vx,&obj.mpar_lmd,jc0,&obj);
    useThread[8]=thread(calz_3d,&obj.tyy_pdz_t2,&obj.tyy_pdz_t1,\
        &obj.vz,&obj.mpar_lmd,jc0,&obj);
    useThread[9]=thread(calz_3d,&obj.tzz_pdz_t2,&obj.tzz_pdz_t1,\
        &obj.vz,&obj.mpar_lmd_add_2miu,jc0,&obj);
    useThread[10]=thread(calx_3d,&obj.tzz_pdx_t2,&obj.tzz_pdx_t1,\
        &obj.vx,&obj.mpar_lmd,jc0,&obj);
    useThread[11]=thread(caly_3d,&obj.tzz_pdy_t2,&obj.tzz_pdy_t1,\
        &obj.vy,&obj.mpar_lmd,jc0,&obj);
    for(k=3;k<12;k++){
        if(useThread[k].joinable())
            useThread[k].join();
...
void TimeSliceCal_elastic2D_MultiThread(class elastic3D_ARMA & obj)
{
    ...
    obj.ompThreadNum=int(obj.maxThreadNum/4);
    //obj.ompThreadNum=int(obj.maxThreadNum/9);
    obj.ompThreadNum=min(obj.ompThreadNum,obj.nz);
    obj.ompThreadNum=min(obj.ompThreadNum,obj.nx);
    obj.ompThreadNum=max(obj.ompThreadNum,1);
    ...
    //obj.txy=obj.txy_pdy_t1+obj.txy_pdx_t1;
    obj.txz=obj.txz_pdz_t1+obj.txz_pdx_t1;
    //.tyz=obj.tyz_pdz_t1+obj.tyz_pdy_t1;
    delete [] useThread;
}
