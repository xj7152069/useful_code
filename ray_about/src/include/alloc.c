...
/*float complex *alloc1complex(size_t n1)
{
	return (float complex*)alloc1(n1,sizeof(float complex));
}*/

/* re-allocate a 1-d array of complexs */
/*float complex *realloc1complex(float complex *v, size_t n1)
{
	return (float complex*)realloc1(v,n1,sizeof(float complex));
}*/

/* free a 1-d array of complexs */
/*void free1complex(float complex *p)
{
	free1(p);
}*/

/* allocate a 2-d array of complexs */
/*float complex **alloc2complex(size_t n1, size_t n2)
{
	return (float complex**)alloc2(n1,n2,sizeof(float complex));
}*/

/* free a 2-d array of complexs */
/*void free2complex(float complex **p)
{
	free2((void**)p);
}*/
