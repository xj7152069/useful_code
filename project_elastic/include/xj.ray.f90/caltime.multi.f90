...
program main
	...
	INTEGER NS_X, NS_Z, NVX, NVZ,ix,iz
	REAL    DVX, DVZ
	REAL	DSTEP,DXS,DZS
	REAL    SX_LEFT,SX_RIGHT,DEPTH
	...
	ALLOCATE(TIME_OUT(1:NVZ,1:NVX))
	ALLOCATE(VEL(1:NVZ,1:NVX))
...
!==================================================================
	SUBROUTINE CAL_TRAVELTIME_2D(NS_X, NS_Z, NVX, NVZ, DEPTH, &
        DVX, DVZ, DXS, DZS, SX_LEFT, SX_RIGHT, VEL, TIME_OUT)
!    PROGRAM TRAVELTIME_2D				

		INTEGER NS_X, NS_Z, NVX, NVZ
		REAL    DVX, DVZ
		REAL	DSTEP,DXS,DZS
		REAL    SX_LEFT,SX_RIGHT,DEPTH
		DIMENSION VEL(NVZ,NVX), TIME_OUT(NVZ,NVX)
!		REAL,intent(inout)::VEL(1:NVZ,1:NVX)
!		REAL,intent(inout)::TIME_OUT(1:NVZ,1:NVX)

		INTEGER NXS_LEFT, NXS_RIGHT
		INTEGER ISHOT,MYID,NX, NZ, NVXS,NVZS
		REAL	SX_COORD, VX_START
		REAL	DS_X, DS_Z,DX, DZ
		REAL	SZ_COORD
