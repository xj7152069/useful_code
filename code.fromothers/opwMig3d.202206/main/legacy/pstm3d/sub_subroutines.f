...
*=====================================================================*
     ...
     +         IphrR1, IphrR2 )
      ...
      INTEGER Nvtau, Iphr1, Iphr2, IBREAK, ViscoFlag
      ...
      Ktaur     = 400
      Ktauw     = 600
      FNTMPW    = '/tmp/XYWslice_600_Iphr_'
      FNTMPR    = '/tmp/XYWslice_400_Iphr_'
      IphrR1    = 1
      IphrR2    = 1
      IBREAK    = 0
...
C     READ (13,*) CTMP, IBREAK         ! Break-Point flag. =0, new; =1, continue.
      READ (13,*) CTMP, ViscoFlag      ! Visco-acoustic flag. =0, acoustic; =1, visco-.
      READ (13,*) CTMP, NtauExtraP     ! Extrapolation number.
C     READ (13,*) CTMP, ITauBreak      ! Tau-Axis Break-Point flag. =0, from surface; =1, from Ktau.
C     READ (13,*) CTMP, Ktaur          ! Tau-Axis Extrapolation Start-Reading Point.
C     READ (13,*) CTMP, Ktauw          ! Tau-Axis Extrapolation Start-Writing Point.
C     READ (13,'(A)') FNTMPW           ! Temp dir and file preffix.
C     READ (13,'(A)') FNTMPR           ! Temp dir and file preffix.
C     READ (13,*) CTMP, IphrR1         ! The first Ray-paramter number.
C     READ (13,*) CTMP, IphrR2         ! The last  Ray-paramter number.
