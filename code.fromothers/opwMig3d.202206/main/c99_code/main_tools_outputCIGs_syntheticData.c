...
{
    char prog_dir[FILE_NAME_MAX_LENGTH]="/home/fb/data/syntheticData";
...
// for synthetic 3-D data
    ...
    for(int iphr = iphr1; iphr <= iphr2; ++iphr)
    {
        ...
        sprintf(fn_commPhrImage, "%s/cigsOpwMig3D_ns4000_t0_500_1000_1500_ms_Iphr_%d.dat", prog_dir, iphr);
