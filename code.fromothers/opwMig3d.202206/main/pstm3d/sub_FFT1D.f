...
C     SPECIFICATIONS FOR ARGUMENTS
      !2022.05.05, FengBo modified the size of IWK and WK.
      !forrtl: severe (408): fort: (2): Subscript #1 of the array WK has value 12021
      !which is greater than the upper bound of 8192
      !INTEGER IWK(4096*2)
      !REAL WK(4096*2)
      INTEGER IWK(16384*2)
      REAL WK(16384*2)
