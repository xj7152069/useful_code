...
typedef struct {	/* segy - trace identification header */
	...
	*/
	// Feng bo modified the following four elements for CMP gather. 2016.04.
	// the type of following four elements can be adjusted if necessary.
	int	cdpno;	// 181-184, sample spacing for non-seismic data //

	float	dcdp;	// 185-188, first sample location for non-seismic data //

	int	lineno;	// 189-192, sample spacing between traces //
