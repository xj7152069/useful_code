#ifndef FBSEGY_NWGI_H
#define FBSEGY_NWGI_H
...
typedef struct {    /* segy - trace identification header */
    ...
    // Feng bo modified the following four elements for Luojia CMP gather.
    // the type of following four elements can be adjusted if necessary.
    //int     byte181;  // 181-184, sample spacing for non-seismic data //
    int     lineno;     // 181-184, sample spacing for non-seismic data //

    //float   dcdp;     // 185-188, first sample location for non-seismic data //
    //int     byte185;  // 185-188, first sample location for non-seismic data //
    int     cdpno;      // 185-188, first sample location for non-seismic data //

    int     byte189;    // 189-192, sample spacing between traces //

    //float   dline;    // 193-196, first trace location //
    int     byte193;    // 193-196, first trace location //
    ...
    */
    ...
    int byte197;        // 197-200, not used yet. //

    int byte201;        // 201-204, not used yet. //
    int byte205;        // 205-208, first-arrival, ms.
    int byte209;        // 209-212, not used yet. //
    int byte213;        // 213-216, not used yet. //
    int byte217;        // 217-220, not used yet. //
    int byte221;        // 221-224, not used yet. //
    int byte225;        // 225-228, not used yet. //
    int byte229;        // 229-232, not used yet. //
    int byte233;        // 233-236, not used yet. //
    int byte237;        // 237-240, not used yet. //
} fbsegy_nonstd_NWGI;
