...
/*===== Main Process of 3d PlaneWave Decomposition. ==================*/
	...
	int	nt_in	= 1601;
	int	nVcdp	= 3881;
	char	vrmsfile[FILE_NAME_MAX_LENGTH]="/home/icluster/vel2d_nx3881_ns1601.sm_r1_25_r2_200.dat";
	float	**velin	= alloc2float(nt_in, nVcdp);

	read_2d_float_rb(velin, nVcdp, nt_in, vrmsfile);
	if ( np == 1 )
